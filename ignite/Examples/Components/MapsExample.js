...
class AnimatedViews extends React.Component {
  ...
  render () {
    ...
    return (
      <Image source={require('./map.png')} style={styles.container}>
        <PanController
...
class ProposalMapItem extends React.Component {
  render () {
    return (
      <View style={{padding: 20}}>
        <Text>Some proposal</Text>
        <Text style={{fontSize: 20, fontWeight: '500'}}>40$</Text>
        <Text>Long description Long description Long description Long description Long description </Text>
      </View>
    )
  }
}
